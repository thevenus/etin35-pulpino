...
#  Created by Genus(TM) Synthesis Solution 16.12-s027_1 on Tue May 14 11:18:34 +0200 2024
...
create_clock -name "clk_spi" -add -period 100.0 -waveform {0.0 50.0} [get_ports spi_clk]
set_clock_transition -max 0.2 [get_clocks clk_spi]
create_clock -name "clk_jtag" -add -period 100.0 -waveform {0.0 50.0} [get_ports jtag_clk]
set_clock_transition -max 0.2 [get_clocks clk_jtag]
set_clock_groups -asynchronous -group [get_clocks clk] -group [get_clocks clk_spi] -group [get_clocks clk_jtag]
set_clock_gating_check -setup 0.0 
set_input_delay -clock [get_clocks clk_jtag] -add_delay 0.5 [get_ports jtag_clk]
set_input_delay -clock [get_clocks clk_jtag] -add_delay 0.5 [get_ports spi_clk]
set_input_delay -clock [get_clocks clk_jtag] -add_delay 0.5 [get_ports clk]
set_input_delay -clock [get_clocks clk_jtag] -add_delay 0.5 [get_ports {INP[0]}]
set_input_delay -clock [get_clocks clk_jtag] -add_delay 0.5 [get_ports {INP[1]}]
set_input_delay -clock [get_clocks clk_jtag] -add_delay 0.5 [get_ports {INP[2]}]
set_input_delay -clock [get_clocks clk_jtag] -add_delay 0.5 [get_ports {INP[3]}]
set_input_delay -clock [get_clocks clk_jtag] -add_delay 0.5 [get_ports {INP[4]}]
set_input_delay -clock [get_clocks clk_jtag] -add_delay 0.5 [get_ports {INP[5]}]
set_input_delay -clock [get_clocks clk_jtag] -add_delay 0.5 [get_ports {INP[6]}]
set_input_delay -clock [get_clocks clk_jtag] -add_delay 0.5 [get_ports {INP[7]}]
set_input_delay -clock [get_clocks clk_jtag] -add_delay 0.5 [get_ports {INP[8]}]
set_input_delay -clock [get_clocks clk_jtag] -add_delay 0.5 [get_ports {INP[9]}]
set_input_delay -clock [get_clocks clk_jtag] -add_delay 0.5 [get_ports {INP[10]}]
set_input_delay -clock [get_clocks clk_jtag] -add_delay 0.5 [get_ports {INP[11]}]
set_input_delay -clock [get_clocks clk_jtag] -add_delay 0.5 [get_ports {INP[12]}]
set_input_delay -clock [get_clocks clk_jtag] -add_delay 0.5 [get_ports {INP[13]}]
set_output_delay -clock [get_clocks clk_jtag] -add_delay 0.5 [get_ports {UTP[0]}]
set_output_delay -clock [get_clocks clk_jtag] -add_delay 0.5 [get_ports {UTP[1]}]
set_output_delay -clock [get_clocks clk_jtag] -add_delay 0.5 [get_ports {UTP[2]}]
set_output_delay -clock [get_clocks clk_jtag] -add_delay 0.5 [get_ports {UTP[3]}]
set_output_delay -clock [get_clocks clk_jtag] -add_delay 0.5 [get_ports {UTP[4]}]
set_output_delay -clock [get_clocks clk_jtag] -add_delay 0.5 [get_ports {UTP[5]}]
set_output_delay -clock [get_clocks clk_jtag] -add_delay 0.5 [get_ports {UTP[6]}]
set_output_delay -clock [get_clocks clk_jtag] -add_delay 0.5 [get_ports {UTP[7]}]
set_output_delay -clock [get_clocks clk_jtag] -add_delay 0.5 [get_ports {UTP[8]}]
set_output_delay -clock [get_clocks clk_jtag] -add_delay 0.5 [get_ports {UTP[9]}]
set_output_delay -clock [get_clocks clk_jtag] -add_delay 0.5 [get_ports {UTP[10]}]
...
set_clock_latency -max 0.5 [get_ports clk]
set_clock_latency -source -max 0.5 [get_ports clk]
