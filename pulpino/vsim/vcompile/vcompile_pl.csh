...
vlog -quiet -work ${LIB_PATH} ${PULP_PATH}/../mmu_pnr/outputs/pulpino_top_pnr.v     || exit 1
echo "${Cyan}--> PL Pulpino Top compilation complete! ${NC}"
...
echo ""
echo "${Green}--> PL PULPino platform compilation complete! ${NC}"
echo ""