...
create_library_set -name SS\
   -timing\
    [list ${::IMEX::libVar}/mmmc/CLOCK65LPLVT_wc_0.90V_125C_10y.lib\
    ${::IMEX::libVar}/mmmc/CORE65LPLVT_wc_0.90V_125C_10y.lib\
    ${::IMEX::libVar}/mmmc/IO65LPHVT_SF_1V8_50A_7M4X0Y2Z_wc_0.90V_1.65V_125C_10y.lib\
    ${::IMEX::libVar}/mmmc/IO65LP_SF_BASIC_50A_ST_7M4X0Y2Z_wc_0.90V_125C_10y.lib\
...
create_library_set -name FF\
   -timing\
    ...
    ${::IMEX::libVar}/mmmc/SPHD110420_bc_1.30V_m40C.lib\
    ${::IMEX::libVar}/mmmc/Pads_Oct2012.lib]
create_op_cond -name WCCON -library_file ${::IMEX::libVar}/mmmc/CORE65LPLVT_wc_0.90V_125C_10y.lib -P 1 -V 0.9 -T 125
...
create_delay_corner -name SS\
   -library_set SS\
   -opcond_library ${::IMEX::libVar}/mmmc/CORE65LPLVT_wc_0.90V_125C_10y.lib\
   -opcond WCCON\
   -rc_corner SS
